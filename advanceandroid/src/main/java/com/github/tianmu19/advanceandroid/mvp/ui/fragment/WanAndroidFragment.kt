...
import com.github.tianmu19.advanceandroid.di.component.DaggerWanAndroidComponent
...
import com.github.tianmu19.advanceandroid.mvp.presenter.WanAndroidPresenter
 ...
 * }
 */
class WanAndroidFragment : BaseFragment<WanAndroidPresenter>(), WanAndroidContract.View {
    companion object {
        fun newInstance(): WanAndroidFragment {
            val fragment = WanAndroidFragment()
            return fragment
        }
    }
    ...
    override fun setupFragmentComponent(appComponent: AppComponent) {
        DaggerWanAndroidComponent //如找不到该类,请编译一下项目
            .builder()
