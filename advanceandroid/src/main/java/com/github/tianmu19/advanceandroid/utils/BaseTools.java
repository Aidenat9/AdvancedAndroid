...
public class BaseTools {
    ...
    public static String getVersionName() {
        ...
        try {
            packInfo = packageManager.getPackageInfo(MyApp.instance.getPackageName(), 0);
    ...
    public static void copy(String content) {
        // 得到剪贴板管理器
        ClipboardManager cmb = (ClipboardManager) MyApp.instance.getSystemService(Context.CLIPBOARD_SERVICE);
