 ...
 * Description:
 * <p>
 * Created by MVPArmsTemplate on 02/15/2019 14:45
 ...
 * }
 */
class DrycargoFragment : BaseFragment<DrycargoPresenter>(), DrycargoContract.View {
    companion object {
    ...
    override fun initView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.fragment_drycargo, container, false);
    }
